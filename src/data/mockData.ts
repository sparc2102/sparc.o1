...
export const mockEvents: Event[] = [
  {
    id: '1',
    title: 'SPARC Insight Series: Future of Drug Discovery',
    date: '2024-12-15T18:00:00Z',
    type: 'webinar',
    description: 'Join industry leaders as they discuss emerging trends in drug discovery, including AI applications, personalized medicine, and novel therapeutic targets.',
    accessTiers: ['genesis', 'professional', 'fellows'],
    capacity: 500,
    registered: 234,
    speaker: 'Dr. Sarah Chen, Chief Scientist at PharmaCorp',
    category: 'insight-series',
    duration: '90 minutes',
    location: 'Virtual',
    tags: ['drug-discovery', 'ai', 'innovation']
  },
  {
    id: '2',
    title: 'Professional Networking Mixer - Boston',
    date: '2024-12-20T19:00:00Z',
    type: 'networking',
    description: 'Connect with pharmaceutical professionals in the Boston area. Enjoy drinks, appetizers, and meaningful conversations with industry peers.',
    ...
    duration: '3 hours',
    location: 'Boston, MA',
    tags: ['networking', 'boston', 'career']
  },
  {
    id: '3',
    title: 'Career Bootcamp: Breaking into Biotech',
    date: '2024-12-18T14:00:00Z',
    type: 'bootcamp',
    description: 'Comprehensive workshop covering resume optimization, interview strategies, and networking techniques specifically for biotech careers.',
    accessTiers: ['genesis', 'professional'],
    capacity: 200,
    registered: 156,
    speaker: 'Career Development Team',
    category: 'career-development',
    duration: '4 hours',
    location: 'Virtual',
    tags: ['career', 'biotech', 'students']
  },
  {
    id: '4',
    title: 'Executive Masterclass: Leadership in Pharma',
    date: '2024-12-22T16:00:00Z',
    type: 'masterclass',
    description: 'Advanced leadership strategies for pharmaceutical executives, covering team management, strategic decision-making, and industry transformation.',
    accessTiers: ['professional', 'fellows'],
    capacity: 50,
    registered: 42,
    speaker: 'Dr. Michael Roberts, CSO at BioInnovate',
    category: 'leadership',
    duration: '2 hours',
    location: 'Virtual',
  ...
  },
  {
    ...
    type: 'forum',
    description: 'Present your research, find collaborators, and explore funding opportunities in an interactive forum setting.',
    accessTiers: ['genesis', 'professional', 'fellows'],
    capacity: 150,
    registered: 89,
    speaker: 'Research Community',
    category: 'research',
    duration: '2.5 hours',
    location: 'Virtual',
    tags: ['research', 'collaboration', 'funding']
  }
];
